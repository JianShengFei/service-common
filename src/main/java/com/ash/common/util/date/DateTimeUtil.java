package com.ash.common.util.date;
...
/**
 * @program: service-common
 * @description: JDK8 LocalDateTime 时间工具类
 * @author: jianshengfei
 * @create: 2020-10-16 09:29
 **/
public class DateTimeUtil {
     ...
     * 例如:202010161000
     */
    public static final String DATE_TIME_NO_SIGN = "yyyyMMddHHmm";
    ...
    public static Date getCurrentTime() {
        ...
        LocalTime localTime = LocalTime.now();
        localTime = LocalTime.of(localTime.getHour(), 0, 0);
